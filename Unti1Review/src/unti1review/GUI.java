...
public class GUI extends javax.swing.JFrame {
    Unit1Review test = new Unit1Review();
    ...
    private void goButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goButtonActionPerformed
        ...
        test.init();
        String msg = "The array average is :" + test.getAvg() + "\n"
                + "The number of values above the average is " 
                + test.getNumAboveAvg() + "\n";
        textAreaMain.setText(msg);
